...
realized it didn't actually work for me. Nearly three years later, I decided to start
...
This is a completely new site, not a migration - I started fresh with different content
and structure. Only 2 pieces of technology stayed: **TypeScript** and **Tailwind**. No
matter what project I do, these are always present.
...
A sub-300 kB (uncompressed) homepage with perfect Lighthouse scores and proper Google
indexing. But more than the metrics, the real win is that I finally feel motivated to
write. Writing MDX files feels natural, like writing code - which is exactly what I
wanted.
...
I hope this insight gave you at least a bit of valuable information I learned while
