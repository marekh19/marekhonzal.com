---
title: 'Migrating from Next.js to Astro: Performance and SEO - A Case Study'
description:
  'Case study: Migrating a personal website from Next.js to Astro. Discover how I achieved
  perfect Lighthouse scores, improved SEO, and simplified my content workflow with MDX and
  static generation.'
date: 2025-11-03
isDraft: false
isFeatured: true
