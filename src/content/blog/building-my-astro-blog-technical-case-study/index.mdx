---
title: 'Building My Astro Blog: Technical Case Study'
description:
...
In
[Part 1: Rebuilding My Website with Astro](/blog/rebuilding-my-website-with-astro-why-and-results),
...
const config = {
  url: 'https://a7s.hnzl.dev/script.js',
...
At the time of writing, Astro had an
[experimental CSP hashes feature](https://docs.astro.build/en/reference/configuration-reference/#securitycsp)
that I couldn’t make work with Cloudflare Workers and a global policy. It has since been
fully released — I haven’t revisited it yet, but plan to at some point.
