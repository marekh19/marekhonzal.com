...
For the compile-time side of this story — how `as const`, `readonly`, and discriminated
unions prevent bugs before your code even runs — I wrote about the patterns I use daily in
[Immutable by Default: Practical TypeScript Patterns](/blog/immutable-by-default-typescript).

_Narrowland is ready for use in your next project. Check it out on
[npmx](https://npmx.dev/package/narrowland) for more details and examples._
