...
excellent [tRPC tutorial](https://youtu.be/PKy2lYEnhgs). The result was "Cutest Pokémon" -
a simple voting app where users choose between two randomly selected Pokémon. While
