...
description:
  A fun little app where everyone can choose from 2 Pokémons and decide which one is
...
"Cutest Pokémon" - a simple voting app where users choose between two randomly selected
Pokémon. While heavily based on the tutorial, I made some modifications to make it my own
learning experience.
...
The app randomly selects two Pokémon from the Pokedex and lets users vote on which is
...
- I don’t use **CSS-in-JS** anymore - I don’t think it’s the right approach, but that’s a
...
"Cutest Pokémon" is exactly what it sounds like - a learning project that helped me
understand the basics of modern full-stack development. It’s not impressive code, but it
